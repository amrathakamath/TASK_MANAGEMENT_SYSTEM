...
/* ---------------------- Admin Login Check ----------------------------------- */
	            ...
	            $_SESSION['temp_password'] = $userRow['temp_password'];
          		...
          		if($userRow['temp_password'] == null){
	                header('Location: task-info.php');
          			...
          			header('Location: changePasswordForstudent.php');
          		}
    ...
    public function change_password_for_student($data){
...
/* ------update_user_password------------------*/
	...
	public function update_user_password($data, $id){
		$student_password  = $this->test_form_input_data(md5($data['student_password']));
		
		try{
			$update_user_password = $this->db->prepare("UPDATE tbl_admin SET password = :x WHERE user_id = :id ");

			$update_user_password->bindparam(':x', $student_password);
