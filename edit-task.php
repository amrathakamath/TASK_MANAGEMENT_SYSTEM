...
$unix_deadline = $deadlineDateTime->getTimestamp();
$unix_current_time = $currentDateTime->getTimestamp();
			...
			<h3 class="text-center bg-primary" style="padding: 7px;">Edit Task </h3><br>
					...
					<div class="col-md-12">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
							<button type="submit" name="update_task_info" class="btn btn-success-custom" id="updateButton" >Update Now</button>
...
echo "<script>
    var formattedCurrentTime = $unix_current_time; // PHP Unix timestamp for current time
    var formattedDeadline = $unix_deadline; // PHP Unix timestamp for deadline
    // Get the button element
    var updateButton = document.getElementById('updateButton');
    if (formattedCurrentTime > formattedDeadline) {
	updateButton.disabled = true; // Disable the button if the deadline has passed
}
</script>";
?>
